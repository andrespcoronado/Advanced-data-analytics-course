...
Welcome to the **Advanced Analytics Course**! This course is designed to provide you with hands-on experience using spatial real-world data to guide decision-making processes. You will work with an **Octagonal Analytics Platform (Plátano)**, which integrates data analysis techniques into anticipative decision-making workflows.
